    ...
    <div className=" flex flex-col lg:px-[140px] lg:min-h-[300px] items-center mb-12 pb-32 justify-center bg-slate-900 ">
      ...
      <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-14">
        {projects.map((project) => (
          <a
            className="flex flex-col relative items-center justify-center w-[36rem] h-[20rem] rounded-2xl ring-8 ring-slate-800"
            key={project.name}
            href={project.link}
            target="_blank"
          >
            ...
            >
              ...
              <button className=" my-2 hover:translate-y-0.5 transition-all"><a href={project.github} target="_blank">{gitHubIcon}</a></button>
            </div>
          </a>
        ))}
      </div>
